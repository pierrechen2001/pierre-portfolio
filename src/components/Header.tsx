      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a href="https://www.linkedin.com/in/guanyu-chen-989117303/" target="_blank" rel="noopener noreferrer" 
               className="text-gray-400 hover:text-white transition-colors">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
...
function NavLink({ href, label }: { href: string; label: string }) {
  return (
    ...
    >
      {label}
      <span className="absolute bottom-0 left-0 w-full h-0.5 bg-[#F3C14B] transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
    </Link>
  );
} 